...
- Gesture recognizers (`TapGestureRecognizer`, `PanGestureRecognizer`, drag/drop, pinch, etc.) are currently not supported. The previous implementation depended on internal MAUI APIs; it will be rewritten against MAUI's `IGesturePlatformManager` seam once that becomes public ([dotnet/maui#33364](https://github.com/dotnet/maui/issues/33364)).
