...
namespace Maui.Controls.Sample.Pages
{
	public partial class TitleBarPage : ContentPage
	{
		...
		public TitleBarPage()
		{
			...
			_customTitleBar.SetBinding(TitleBar.TitleProperty, nameof(TitleBarSampleViewModel.Title));
			_customTitleBar.SetBinding(TitleBar.SubtitleProperty, nameof(TitleBarSampleViewModel.Subtitle));
			_customTitleBar.SetBinding(TitleBar.IsVisibleProperty, nameof(TitleBarSampleViewModel.ShowTitleBar));
