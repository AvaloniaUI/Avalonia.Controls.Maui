...
public class HomeViewModel : INotifyPropertyChanged
{
    ...
    public HomeViewModel()
    {
        ...
        ToggleModeCommand = new Command(() => {
            Microsoft.Maui.Controls.Application.Current!.UserAppTheme = Microsoft.Maui.Controls.Application.Current!.UserAppTheme == AppTheme.Light ? AppTheme.Dark : AppTheme.Light;
        });
    }
