...
public static class BenchmarkRegistry
{
    ...
    static BenchmarkRegistry()
    {
        ...
        Register<ScrollViewScrollPerformanceBenchmark>();
        ...
        Register<CollectionViewLongScrollBenchmark>();
        Register<CollectionViewGroupedMutationBenchmark>();
        Register<CollectionViewEmptyViewToggleBenchmark>();
        Register<NavigationPerformanceBenchmark>();
        Register<NavigationModalPerformanceBenchmark>();
        Register<NavigationBranchPerformanceBenchmark>();
        Register<ShellRouteNavigationPerformanceBenchmark>();
        Register<ShellRouteModalStackPerformanceBenchmark>();
        Register<ShellTabSwitchPerformanceBenchmark>();
        Register<ShellNavigationStackPerformanceBenchmark>();
        Register<ShellFlyoutPerformanceBenchmark>();
        ...
        Register<ShellNavigationWithModalsAndFlyoutLeakBenchmark>();
