...
/// </summary>
public static class CaruselViewExtensions
{
    ...
    public static void UpdateItemsSource(this AvaloniaCarousel platformView, MauiItemsView itemsView)
    {
    ...
    public static void UpdateItemTemplate(this AvaloniaCarousel platformView, MauiItemsView itemsView, CarouselViewHandler handler)
    {
        ...
        {
            platformView.ItemTemplate = new FuncDataTemplate<object>((item, _) => CreateTextItem(item));
            return;
        }
        ...
        platformView.ItemTemplate = new FuncDataTemplate<object>((item, _) =>
        {
            ...
            if (itemsView is Element parentElement)
            {
