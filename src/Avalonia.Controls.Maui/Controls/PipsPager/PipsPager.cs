...
public class PipsPager : TemplatedControl
{
    ...
    public static readonly RoutedEvent<PipsPagerSelectedIndexChangedEventArgs> SelectedIndexChangedEvent =
        RoutedEvent.Register<PipsPager, PipsPagerSelectedIndexChangedEventArgs>(nameof(SelectedIndexChanged),
    ...
    static PipsPager()
    {
        ...
        IsPreviousButtonVisibleProperty.Changed.AddClassHandler<PipsPager>((x, e) =>
            x.OnIsPreviousButtonVisibleChanged(e));
    ...
    private void AnimateScrollOffset(ScrollViewer scrollViewer, double targetOffset, bool isHorizontal)
    {
        ...
        DispatcherTimer.RunOnce(
            () => AnimateStep(scrollViewer, startOffset, delta, startTime, durationMs, isHorizontal, token),
